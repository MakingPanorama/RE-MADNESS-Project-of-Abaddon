...
================================================================================================================= ]]
function modifier_ultimate_heart_datadriven_regen_on_take_damage(keys)
	...
	if keys.caster:HasModifier("modifier_ultimate_heart_datadriven_regen_visible") then
		keys.caster:RemoveModifierByNameAndCaster("modifier_ultimate_heart_datadriven_regen_visible", keys.caster)
	end
end
...
================================================================================================================= ]]
function modifier_ultimate_heart_datadriven_regen_on_interval_think(keys)
	if keys.ability:IsCooldownReady() and keys.caster:IsRealHero() then
		...
		if not keys.caster:HasModifier("modifier_ultimate_heart_datadriven_regen_visible") then
			keys.ability:ApplyDataDrivenModifier(keys.caster, keys.caster, "modifier_ultimate_heart_datadriven_regen_visible", {duration = -1})
		end
	elseif keys.caster:HasModifier("modifier_ultimate_heart_datadriven_regen_visible") then  --This is mostly a failsafe.
		keys.caster:RemoveModifierByNameAndCaster("modifier_ultimate_heart_datadriven_regen_visible", keys.caster)
	end
end
...
================================================================================================================= ]]
function modifier_ultimate_heart_datadriven_regen_on_destroy(keys)
	keys.caster:RemoveModifierByNameAndCaster("modifier_ultimate_heart_datadriven_regen_visible", keys.caster)
end
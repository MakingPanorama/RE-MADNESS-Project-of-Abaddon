LinkLuaModifier("modifier_power_buildings_creep_buff", "npc_abilities/unit_spawner.lua", LUA_MODIFIER_MOTION_NONE)
...
function SpawnUnits(keys)
  ...
  local increased_cooldown = math.floor(GameRules.roundSeconds / 100)

...
LinkLuaModifier("modifier_treant_little_tree_thinker", "npc_abilities\treant_little_tree", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_treant_little_tree_buff", "npc_abilities\treant_little_tree", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_treant_little_tree_debuff", "npc_abilities\treant_little_tree", LUA_MODIFIER_MOTION_NONE)

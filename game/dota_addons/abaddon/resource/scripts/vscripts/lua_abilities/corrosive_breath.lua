LinkLuaModifier("modifier_emerald_dragon_corrosive_breath", "lua_abilities/corrosive_breath.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_emerald_dragon_corrosive_breath_debuff", "lua_abilities/corrosive_breath.lua", LUA_MODIFIER_MOTION_NONE)

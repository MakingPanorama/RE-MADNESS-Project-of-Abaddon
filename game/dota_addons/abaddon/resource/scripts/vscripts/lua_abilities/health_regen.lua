...
LinkLuaModifier("spell_lab_survivor_health_regen_modifier", "lua_abilities/health_regen.lua", LUA_MODIFIER_MOTION_NONE)
...
if spell_lab_survivor_health_regen_modifier == nil then
	spell_lab_survivor_health_regen_modifier = require "lua_abilities/base"
end

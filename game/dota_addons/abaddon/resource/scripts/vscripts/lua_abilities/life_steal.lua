...
LinkLuaModifier("spell_lab_survivor_life_steal_modifier", "lua_abilities/life_steal.lua", LUA_MODIFIER_MOTION_NONE)
...
if spell_lab_survivor_life_steal_modifier == nil then
	spell_lab_survivor_life_steal_modifier = require "nouse/base_modifier"
end

...
LinkLuaModifier("modifier_deep_freeze","lua_abilities/lich_deep_freeze",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_deep_freeze_stun","lua_abilities/lich_deep_freeze",LUA_MODIFIER_MOTION_NONE)

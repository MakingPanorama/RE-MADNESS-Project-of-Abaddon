LinkLuaModifier("modifier_bear_feral_rage", "lua_abilities/feral_rage.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_bear_feral_rage_buff", "lua_abilities/feral_rage.lua", LUA_MODIFIER_MOTION_NONE)

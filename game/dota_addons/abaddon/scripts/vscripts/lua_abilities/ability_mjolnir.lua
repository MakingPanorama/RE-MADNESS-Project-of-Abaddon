...
LinkLuaModifier( "modifier_ability_mjolnir", "lua_abilities/ability_mjolnir.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_mjolnir_op", "lua_abilities/ability_mjolnir.lua", LUA_MODIFIER_MOTION_NONE )

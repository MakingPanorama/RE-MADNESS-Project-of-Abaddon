...
LinkLuaModifier("modifier_acron_battle_fevor","lua_abilities\acron_battle_fevor.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_acron_battle_fevor_buff","lua_abilities\acron_battle_fevor.lua",LUA_MODIFIER_MOTION_NONE)

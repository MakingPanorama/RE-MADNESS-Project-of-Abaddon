...
LinkLuaModifier("modifier_basic_xpm_bonus","lua_abilities/basic_experience_bonus.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_basic_xpm_bonus_op","lua_abilities/basic_experience_bonus.lua",LUA_MODIFIER_MOTION_NONE)

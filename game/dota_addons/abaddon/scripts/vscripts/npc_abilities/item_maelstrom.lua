...
-----------------------------------------------------------------------------------------------------------
LinkLuaModifier( "modifier_item_imba_maelstrom", "npc_abilities\item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )			-- Owner's bonus attributes, stackable
...
--	Mjollnir definition
-----------------------------------------------------------------------------------------------------------
LinkLuaModifier( "modifier_item_imba_mjollnir", "npc_abilities\item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )					-- Owner's bonus attributes, stackable
LinkLuaModifier( "modifier_item_imba_mjollnir_counter", "npc_abilities\item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )			-- Attack proc counter
LinkLuaModifier( "modifier_item_imba_mjollnir_static", "npc_abilities\item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )			-- Static shield
LinkLuaModifier( "modifier_item_imba_mjollnir_static_counter", "npc_abilities\item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )	-- Shield proc counter
LinkLuaModifier( "modifier_item_imba_mjollnir_slow", "npc_abilities\item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )				-- Shield slow
...
LinkLuaModifier( "modifier_item_imba_jarnbjorn", "npc_abilities\item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )					-- Owner's bonus attributes, stackable
LinkLuaModifier( "modifier_item_imba_jarnbjorn_counter", "npc_abilities\item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )			-- Attack proc counter
LinkLuaModifier( "modifier_item_imba_jarnbjorn_static", "npc_abilities\item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )			-- Static shield
LinkLuaModifier( "modifier_item_imba_jarnbjorn_static_counter", "npc_abilities\item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )	-- Shield proc counter
LinkLuaModifier( "modifier_item_imba_jarnbjorn_slow", "npc_abilities\item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )				-- Shield slow

...
item_ability_mjolnir = class({})
item_ability_mjolnir_op = class({})
LinkLuaModifier( "modifier_item_ability_mjolnir", "item_abilities/item_ability_mjolnir.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_item_ability_mjolnir_op", "item_abilities/item_ability_mjolnir.lua", LUA_MODIFIER_MOTION_NONE )

function item_ability_mjolnir:GetIntrinsicModifierName()
  return "modifier_item_ability_mjolnir" end

function item_ability_mjolnir_op:GetIntrinsicModifierName()
  return "modifier_item_ability_mjolnir_op" end
...
modifier_item_ability_mjolnir = class({}) 
function modifier_item_ability_mjolnir:IsHidden() return true end
function modifier_item_ability_mjolnir:IsDebuff() return false end
function modifier_item_ability_mjolnir:IsPurgable() return false end
function modifier_item_ability_mjolnir:IsPermanent() return true end


-- Declare modifier events/properties
function modifier_item_ability_mjolnir:DeclareFunctions()
  local funcs = {
...
function modifier_item_ability_mjolnir:OnAttackLanded( keys )
  if IsServer() then
...
modifier_item_ability_mjolnir_op = class({}) 
function modifier_item_ability_mjolnir_op:IsHidden() return true end
function modifier_item_ability_mjolnir_op:IsDebuff() return false end
function modifier_item_ability_mjolnir_op:IsPurgable() return false end
function modifier_item_ability_mjolnir_op:IsPermanent() return true end


-- Declare modifier events/properties
function modifier_item_ability_mjolnir_op:DeclareFunctions()
  local funcs = {
    MODIFIER_EVENT_ON_ATTACK_LANDED,
  }
  return funcs
...
-- On attack landed, roll for proc and apply stacks
function modifier_item_ability_mjolnir_op:OnAttackLanded( keys )
  if IsServer() then
    local attacker = self:GetParent()

...
LinkLuaModifier("modifier_iceheart","item_abilities/shard_magus_iceheart",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_iceheart_slow","item_abilities/shard_magus_iceheart",LUA_MODIFIER_MOTION_NONE)
...
function shard_magus_iceheart:OnProjectileHit(t,l)
	...
	if t then
		...
		ParticleManager:CreateParticle("particles/status_fx/status_effect_frost.vpcf", PATTACH_ABSORIGIN_FOLLOW, t) --[[Returns:int

...
item_ability_mjolnir2 = class({})
item_ability_mjolnir2_op = class({})
LinkLuaModifier( "modifier_item_ability_mjolnir2", "item_abilities/item_ability_mjolnir2.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_item_ability_mjolnir2_op", "item_abilities/item_ability_mjolnir2.lua", LUA_MODIFIER_MOTION_NONE )

function item_ability_mjolnir2:GetIntrinsicModifierName()
  return "modifier_item_ability_mjolnir2" end

function item_ability_mjolnir2_op:GetIntrinsicModifierName()
  return "modifier_item_ability_mjolnir2_op" end
...
modifier_item_ability_mjolnir2 = class({}) 
function modifier_item_ability_mjolnir2:IsHidden() return true end
function modifier_item_ability_mjolnir2:IsDebuff() return false end
function modifier_item_ability_mjolnir2:IsPurgable() return false end
function modifier_item_ability_mjolnir2:IsPermanent() return true end


-- Declare modifier events/properties
function modifier_item_ability_mjolnir2:DeclareFunctions()
  local funcs = {
...
function modifier_item_ability_mjolnir2:OnAttackLanded( keys )
  if IsServer() then
...
modifier_item_ability_mjolnir2_op = class({}) 
function modifier_item_ability_mjolnir2_op:IsHidden() return true end
function modifier_item_ability_mjolnir2_op:IsDebuff() return false end
function modifier_item_ability_mjolnir2_op:IsPurgable() return false end
function modifier_item_ability_mjolnir2_op:IsPermanent() return true end


-- Declare modifier events/properties
function modifier_item_ability_mjolnir2_op:DeclareFunctions()
  local funcs = {
    MODIFIER_EVENT_ON_ATTACK_LANDED,
  }
  return funcs
...
-- On attack landed, roll for proc and apply stacks
function modifier_item_ability_mjolnir2_op:OnAttackLanded( keys )
  if IsServer() then
    local attacker = self:GetParent()

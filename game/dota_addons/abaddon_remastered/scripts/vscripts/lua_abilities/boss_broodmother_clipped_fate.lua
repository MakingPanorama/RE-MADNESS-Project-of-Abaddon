...
LinkLuaModifier("modifier_boss_broodmother_clipped_fate_passive", "lua_abilities/boss_broodmother_clipped_fate", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_boss_broodmother_clipped_fate_debuff", "lua_abilities\boss_broodmother_clipped_fate", LUA_MODIFIER_MOTION_NONE)

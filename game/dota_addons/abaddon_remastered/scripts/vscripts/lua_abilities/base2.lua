if spell_lab_souls_str_modifier == nil then
	spell_lab_souls_str_modifier = class({})
end

function spell_lab_souls_str_modifier:GetSoulsBonus()
...
function spell_lab_souls_str_modifier:OnDeath(kv)
  if IsServer() then
...
function spell_lab_souls_str_modifier:GainSoul (hTarget)
...
function spell_lab_souls_str_modifier:GainSouls (iAmount)
...
function spell_lab_souls_str_modifier:GiveSouls (hTarget)
...
function spell_lab_souls_str_modifier:DropSouls (count)
...
function spell_lab_souls_str_modifier:IsHidden()
	return self:GetStackCount() < 1
end

function spell_lab_souls_str_modifier:AllowIllusionDuplicate ()
  return false
end
function spell_lab_souls_str_modifier:IsPurgable()
	return false
end

function spell_lab_souls_str_modifier:OnCreated(kv)
...
function spell_lab_souls_str_modifier:OnIntervalThink()
	if IsServer() then
...
function spell_lab_souls_str_modifier:GetAttributes()
	return MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE + MODIFIER_ATTRIBUTE_PERMANENT
end
return spell_lab_souls_str_modifier

LinkLuaModifier( "modifier_murlock_shadow_dance", "lua_abilities/murlock_shadow_dance.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_murlock_shadow_dance_illusion", "lua_abilities/murlock_shadow_dance.lua", LUA_MODIFIER_MOTION_NONE )

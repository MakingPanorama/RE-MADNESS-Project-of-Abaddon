LinkLuaModifier("modifier_drow_splitshot", "lua_abilities/drow_splitshot.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_drow_splitshot:OnCreated( kv )
	...
	-- for melee heroes
	if not self.projectile or self.projectile == "particles/units/heroes/hero_gyrocopter/gyro_base_attack.vpcf" then
		self.projectile = "particles/units/heroes/hero_gyrocopter/gyro_base_attack.vpcf"
	end
